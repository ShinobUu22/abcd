...
<html>
  <head>
    ...
    <center><font color="Red"><h1>Himalaya Bank Ltd.</h1></font></center>
  ...
  <body>
    ...
    <div class="">
      ...
      <form class="form-signin" method="post" action=""> 
       ...
       <input type="submit" value="Delete" name="searching">
  ...
  if(isset($_POST['searching'])){
    ...
    if (mysqli_num_rows($result) ==1) {
      ...
      if (mysqli_query($conn, $sql)) {
  	    ...
  	    echo "<br><br><center><font color=Red>Delete Account succssfully !</font></center";
        //echo "Delete Account succssfully";
